                                    ...
                                    <li class="col-6 col-sm-6 col-md-12  mb-3 mb-lg-4 mt-lg-2 mt-0">
                                        ...
                                        <div class="mentionperson d-flex  align-items-center">
                                            @if($book->author->photo)
                                                <img src="{{asset($book->author->photo)}}" class="img-fluid"
                                                     alt="image">
                                            @endif
                    ...
                    <div class="prevItemData d-flex d-md-block flex-wrap">
                        ...
                        @if(\Illuminate\Support\Facades\Auth::check())
                            <div class="bottombad d-flex flex-wrap align-items-center justify-content-between">
                                <div class="wishlist d-block d-md-none d-lg-block" style="cursor: pointer;"
                                     onclick="set_favorite(<?= $book->id ?>)">
                                    <img id="wishlist-img"
                                         src="@if($is_favorite) {{asset('img/wishlist-2.png')}} @else {{asset('img/wishlist-1.png')}} @endif"
                                         class="img-fluid" alt="wishlist">
                                    Избранное
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="aboutitem">
                                    <div class="bgdarkbluecolor aboutitemcnt">
                                        ...
                                        <div class="itemtitlePrice">
                                            ...
                                            <h3 class="textwhitecolor"><strong>{{$popularBook->age_rating}}</strong>
                                            </h3>
                        ...
                        <div class="sign-from contact-form">
                            ...
                            <form method="post" action="{{route('comments.set_review')}}">
                                ...
                                <div class="input-box">
                                    ...
                                    <input id="recommended" type="checkbox" name="recommended" class="form-check-input"
                                           value="Y">
                                </div>
